...
#ifndef USER_DRIVER_OV7725_H_
#define USER_DRIVER_OV7725_H_

#define OV7725_Delay_ms(time)  delayms(time)
#define OV7725_ID           0x21

#define	CAMERA_DMA_CH 	    4			//定义摄像头的DMA采集通道
